...
#===============================================================================
# Manager handling plugin registration and compatibility utilities.
module PluginManager
  # Mixin that bulk-aliases overlapping methods when prepending plugin modules.
  module Aliaser
    ...
    module ClassMethods
      ...
      # @param alias_module [Module] module to prepend and alias against
      # @param extension [String] suffix appended to aliased method names
      # @return [void]
      ...
      # Collects instance methods that overlap with the alias module.
      # @param alias_module [Module] module to compare methods against
      ...
      # Collects class methods that overlap with the alias module.
      # @param alias_module [Module] module to compare methods against
