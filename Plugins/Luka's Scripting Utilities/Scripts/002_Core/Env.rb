...
#===============================================================================
# Environment module for resolving and manipulating common Windows directory
# paths via their known-folder GUIDs.
module ::Env
  class << self
    ...
    # Resolves a known directory path from its common path key.
    # @param type [String] key from COMMON_PATHS (e.g. 'DESKTOP')
    ...
    # @param string [String] GUID string (e.g. 'B4BFCC3A-DB2C-424C-B029-7FE99A87C641')
    # @return [Array<Integer, String>] hex chunks composing the GUID
    ...
    # Returns the current working directory of the game.
    # @return [String] working directory
    def directory
      Dir.pwd
    end

    # Escapes reserved filesystem characters in the given string.
    # @param string [String] string to escape in place
    ...
    # Restores previously escaped filesystem characters in the given string.
    # @param string [String] string to unescape in place
