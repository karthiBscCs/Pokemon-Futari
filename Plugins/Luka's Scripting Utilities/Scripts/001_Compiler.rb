...
module LUTS
  # Custom compiler turning PBS text files into serialized game data files.
  module Compiler
    class << self
      # Collects unique base file names from the given PBS directory.
      # @param path [String] directory to scan for PBS text files
      ...
      # @param path [String] directory containing PBS text files
      # @param schema [Object] module holding the compilation schemas
      # @param file_ext [String] file extension for compiled data files
      # @param force [Boolean] whether to force recompilation of all files
      # @return [void]
      ...
      # @param path [String] PBS text file to compile
      # @param schema [Object] module holding the compilation schemas
      # @param const [Symbol] schema constant to compile against
      # @return [Hash] compiled data hash keyed by section
